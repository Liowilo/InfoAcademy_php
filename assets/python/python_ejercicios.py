...
@python_bp.route("/get_python_question", methods=["GET"])
...
@python_bp.errorhandler(Exception)
...
@python_bp.route("/check_python_answer", methods=["POST"])
def check_python_answer():
    logger.info("Iniciando check_python_answer")
    try:
    ...
    try:
        ...
        if connection and connection.is_connected():
            cursor.close()
            connection.close()
        logger.info("Finalizando check_python_answer")

@python_bp.route("/get_python_performance", methods=["GET"])
...
@python_bp.route("/get_recommendation", methods=["GET"])
